...
#define TOOLKIT_SHARED_PTR_HEADER
    ...
    namespace toolkit
    {
        ...
        public:
            ...
            typedef TYPE   pointed_type;
            typedef size_t counter_type;

        private:

            pointed_type * address;
        ...
        public:
            ...
            explicit Shared_Ptr(pointed_type * given_address)
            :
        ...
        public:
            ...
            explicit Shared_Ptr(std::auto_ptr< pointed_type > other_address)
            :
        ...
        private:
            ...
            void hold (pointed_type * new_address, counter_type * new_counter)
            {
                address = new_address;
                counter = new_counter;
